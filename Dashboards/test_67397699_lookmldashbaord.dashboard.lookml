...
- dashboard: test_67397699_lookmldashbaord
  ...
  - type: button
    name: button_100
    rich_content_json: '{"text":"New Button","description":"","newTab":true,"alignment":"center","size":"medium","style":"FILLED","color":"#1A73E8","href":"https://gcpl260.cloud.looker.com/embed/dashboards/mtr_abraham_thelook::testlookmlbylook"}'
    row: 6
    col: 0
    width: 24
    height: 1
